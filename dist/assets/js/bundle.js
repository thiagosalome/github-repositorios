...
var asc = __webpack_require__(217);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(294)))
...
var $export = __webpack_require__(0);
var $parseInt = __webpack_require__(96);
...
// https://github.com/tc39/proposal-string-pad-start-end
var $export = __webpack_require__(0);
var $pad = __webpack_require__(115);
var userAgent = __webpack_require__(56);
...
var main = __webpack_require__(290);

// CONCATENATED MODULE: ./src/assets/js/modules/polyfill.js
...
// CONCATENATED MODULE: ./src/assets/js/modules/tabs.js
...
function () {
  ...
  tabs_createClass(Tabs, [{
    ...
    value: function init() {
      ...
      this.tabItem.forEach(function (tab) {
    ...
    value: function removeActives() {
      ...
      this.contentItem.forEach(function (content) {
...
// CONCATENATED MODULE: ./src/assets/js/modules/api.js

var api = axios_default.a.create({
  baseURL: "https://api.github.com/"
});
/* harmony default export */ var modules_api = (api);
// CONCATENATED MODULE: ./src/assets/js/modules/message.js
...
function () {
  ...
  message_createClass(Message, null, [{
    key: "show",
...
// CONCATENATED MODULE: ./src/assets/js/modules/repositories.js
...
function repositories_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function repositories_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function repositories_createClass(Constructor, protoProps, staticProps) { if (protoProps) repositories_defineProperties(Constructor.prototype, protoProps); if (staticProps) repositories_defineProperties(Constructor, staticProps); return Constructor; }




var repositories_Respositories =
/*#__PURE__*/
function () {
  function Respositories() {
    repositories_classCallCheck(this, Respositories);
  ...
  repositories_createClass(Respositories, [{
    ...
    value: function registerHandlers() {
      ...
      this.searchForm.addEventListener("submit", function (e) {
        e.preventDefault();
        var text = _this.searchText.value;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return modules_api.get("search/repositories?q=".concat(text));
              ...
              case 3:
                ...
                if (response.data.items.length > 0) {
                  for (i = 0; i < response.data.items.length; i++) {
                    repositoryHTML = "<a class=\"js-repository\" href=\"".concat(response.data.items[i].html_url, "\" title=\"").concat(response.data.items[i].name, "\" data-id=\"").concat(response.data.items[i].id, "\" target=\"_blank\">\n                                  <article class=\"repository\">\n                                    <span class=\"repository__favorite js-favorite\" title=\"Favoritar\"></span>\n                                    <figure class=\"repository__owner-avatar\">\n                                      <img src=\"").concat(response.data.items[i].owner.avatar_url, "\" alt=\"Administrador\" title=\"Administrador\">\n                                    </figure>\n                                    <h2 class=\"repository__owner-name\">").concat(response.data.items[i].owner.login, "</h2>\n                                    <h3 class=\"repository__name\">").concat(response.data.items[i].name, "</h3>\n                                    <p class=\"repository__description\">").concat(response.data.items[i].description === null ? "(Repositório sem descrição)" : response.data.items[i].description, "</p>\n                                    <ul class=\"repository__info\">\n                                      <li><img src=\"./assets/images/view.png\" alt=\"Watch\" title=\"Watch\">\n                                        <p>").concat(response.data.items[i].watchers_count, "</p>\n                                      </li>\n                                      <li><img src=\"./assets/images/star.png\" alt=\"Star\" title=\"Star\">\n                                        <p>").concat(response.data.items[i].stargazers_count, "</p>\n                                      </li>\n                                      <li><img src=\"./assets/images/fork.png\" alt=\"Fork\" title=\"Fork\">\n                                        <p>").concat(response.data.items[i].forks_count, "</p>\n                                      </li>\n                                    </ul>\n                                  </article>\n                                </a>");
                  ...
                  this.repositorySearch.forEach(function (item) {
                    item.addEventListener("click", function (e) {
                      e.preventDefault();

                      if (e.target.classList.contains("js-favorite")) {
                        var favorite = e.currentTarget.querySelector(".js-favorite");
                        var id = e.currentTarget.getAttribute("data-id");

                        if (favorite.classList.contains("active")) {
                          favorite.classList.remove("active");

                          _this2.removeFavorite(id);
                        } else {
                          favorite.classList.add("active");

                          _this2.addFavorite(id);
                        }
                      } else {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                login = JSON.parse(localStorage.getItem("user")).info.login;
                _context2.next = 3;
                return modules_api.get("/users/".concat(login, "/repos"));

              case 3:
                response = _context2.sent;
                this.repositoriesList.innerHTML = "";
                response.data.map(function (repository) {
                  var repositoryHTML = "<a href=\"".concat(repository.html_url, "\" title=\"").concat(repository.name, "\" target=\"_blank\">\n                              <article class=\"repository\">\n                                <h3 class=\"repository__name\">").concat(repository.name, "</h3>\n                                <p class=\"repository__description\">").concat(repository.description === null ? "(Repositório sem descrição)" : repository.description, "</p>\n                                <ul class=\"repository__info\">\n                                  <li><img src=\"./assets/images/view.png\" alt=\"Watch\" title=\"Watch\">\n                                    <p>").concat(repository.watchers_count, "</p>\n                                  </li>\n                                  <li><img src=\"./assets/images/star.png\" alt=\"Star\" title=\"Star\">\n                                    <p>").concat(repository.stargazers_count, "</p>\n                                  </li>\n                                  <li><img src=\"./assets/images/fork.png\" alt=\"Fork\" title=\"Fork\">\n                                    <p>").concat(repository.forks_count, "</p>\n                                  </li>\n                                </ul>\n                              </article>\n                            </a>");

                  _this3.repositoriesList.insertAdjacentHTML("beforeend", repositoryHTML);
                });
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return modules_api.get("repositories/".concat(id));
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                for (i = 0; i < window.user.favorites.length; i++) {
    ...
    value: function updateFavorites() {
      ...
      if (window.user.favorites.length > 0 && _typeof(window.user.favorites) === "object") {
        this.favoritesEmpty.classList.remove("active");
        window.user.favorites.map(function (item) {
          var repositoryHTML = "<a class=\"js-repository\" href=\"".concat(item.html_url, "\" title=\"").concat(item.name, "\" data-id=\"").concat(item.id, "\" target=\"_blank\">\n                                  <article class=\"repository\">\n                                    <span class=\"repository__favorite js-favorite active\" title=\"Remover dos favoritos\"></span>\n                                    <figure class=\"repository__owner-avatar\">\n                                      <img src=\"").concat(item.owner.avatar_url, "\" alt=\"Administrador\" title=\"Administrador\">\n                                    </figure>\n                                    <h2 class=\"repository__owner-name\">").concat(item.owner.login, "</h2>\n                                    <h3 class=\"repository__name\">").concat(item.name, "</h3>\n                                    <p class=\"repository__description\">").concat(item.description === null ? "(Repositório sem descrição)" : item.description, "</p>\n                                    <ul class=\"repository__info\">\n                                      <li><img src=\"./assets/images/view.png\" alt=\"Watch\" title=\"Watch\">\n                                        <p>").concat(item.watchers_count, "</p>\n                                      </li>\n                                      <li><img src=\"./assets/images/star.png\" alt=\"Star\" title=\"Star\">\n                                        <p>").concat(item.stargazers_count, "</p>\n                                      </li>\n                                      <li><img src=\"./assets/images/fork.png\" alt=\"Fork\" title=\"Fork\">\n                                        <p>").concat(item.forks_count, "</p>\n                                      </li>\n                                    </ul>\n                                  </article>\n                                </a>");

          _this4.repositoriesFavorites.insertAdjacentHTML("beforeend", repositoryHTML);
        });
        this.repositoryFavorite = this.repositoriesFavorites.querySelectorAll(".js-repository");
        this.repositoryFavorite.forEach(function (item) {
          item.addEventListener("click", function (e) {
            e.preventDefault();
            ...
            if (e.target.classList.contains("js-favorite")) {
              ...
              if (favorite.classList.contains("active")) {
                ...
                _this4.removeFavorite(id);
              } else {
                favorite.classList.add("active");

                _this4.addFavorite(id);
              }
            } else {
              window.open(e.currentTarget.getAttribute("href"), '_blank');
            }
...
/* harmony default export */ var modules_repositories = (repositories_Respositories);
// CONCATENATED MODULE: ./src/assets/js/modules/login.js
...
function () {
  ...
  login_createClass(Login, [{
    ...
    key: "validateUser",
    value: function () {
      var _validateUser = login_asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 2;
                _context.next = 5;
                return modules_api.get("/users/".concat(this.loginUserName.value));
    ...
    key: "setDataUser",
    value: function setDataUser() {
      if (window.user.info !== null && login_typeof(window.user.info) === "object") {
        if (location.pathname === "/internal.html") {
          var _window$user$info = window.user.info,
              name = _window$user$info.name,
              avatar_url = _window$user$info.avatar_url;
    ...
    key: "configRepositories",
    value: function configRepositories() {
      var repositories = new modules_repositories();
...
/* harmony default export */ var modules_login = (login_Login);
// CONCATENATED MODULE: ./src/assets/js/modules/logout.js
  ...
  logout_createClass(Logout, [{
    ...
    value: function logoutUser() {
      if (this.headerLogout !== null) {
        this.headerLogout.addEventListener("click", function (e) {
          e.preventDefault();
          window.user.info = "";
          localStorage.setItem("user", JSON.stringify(window.user));
          location = "index.html";
    ...
    value: function toggleBox() {
      ...
      if (this.headerUser !== null) {
        this.headerUser.addEventListener("click", function (e) {
          _this.headerBox.classList.toggle("active");
        });
      }
    }
  }]);
...
var main_logout = new logout();
var main_login = new modules_login();
